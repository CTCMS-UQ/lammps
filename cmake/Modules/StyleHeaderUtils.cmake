...
function(RegisterKokkosTallyStyle)
    get_property(files GLOBAL PROPERTY COMPUTE)
    set(hlist)
    foreach(file_name ${files})
        file(STRINGS ${file_name} is_style LIMIT_COUNT 1 REGEX KOKKOS_TALLY_CLASS)
        if(is_style)
            list(APPEND hlist ${file_name})
        endif()
    endforeach()
    set_property(GLOBAL PROPERTY TALLY_KK "${hlist}")
