...
void AtomVecMolecularKokkos::unpack_comm(int n, int first, double *buf)
{
  ...
  // Should this call atomKK->modified()??
}
...
void AtomVecMolecularKokkos::unpack_border(int n, int first, double *buf)
{
  ...
  auto mod_mask = X_MASK|TAG_MASK|TYPE_MASK|MASK_MASK|MOLECULE_MASK;
...
void AtomVecMolecularKokkos::unpack_border_vel(int n, int first, double *buf)
{
  ...
  auto mod_mask = X_MASK|TAG_MASK|TYPE_MASK|MASK_MASK|MOLECULE_MASK|V_MASK;
  if (comm_images) mod_mask |= IMAGE_MASK;
  atomKK->modified(Host,mod_mask);
