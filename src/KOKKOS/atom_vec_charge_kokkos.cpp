...
{
  constexpr auto border_mask = X_MASK|TAG_MASK|TYPE_MASK|MASK_MASK|Q_MASK;
  int m = 0;
...
int AtomVecChargeKokkos::pack_border_vel(int n, int *list, double *buf,
                                   int pbc_flag, int *pbc)
{
  constexpr auto border_mask = X_MASK|TAG_MASK|TYPE_MASK|MASK_MASK|Q_MASK|V_MASK;
  int m = 0;
...
{
  constexpr auto mod_mask = X_MASK|TAG_MASK|TYPE_MASK|MASK_MASK|Q_MASK;
  int m = 0;
  int last = first + n;
...
{
  constexpr auto mod_mask = X_MASK|TAG_MASK|TYPE_MASK|MASK_MASK|Q_MASK|V_MASK;
  int m = 0;
  int last = first + n;
  while (last > nmax) grow(0);
